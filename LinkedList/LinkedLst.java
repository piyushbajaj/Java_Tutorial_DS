...
public class LinkedLst {
   ...
   defined inside LinkedList class shown above */
    ...
    public void insertAfter(Node prev_node, int new_data)
    {
        ...
        if(prev_node == null){
        System.out.println("The Given previous Node is NULL, so not going further");
        return;
        }
        ...
        //4. Make next of new Node as next of prev_node (Now point the next of new_node to next node)
   ...
   defined inside LinkedList class shown above */
    ...
    public void deleteNode(int key){
        ...
        prev.next = temp.next;
        //Node delete_node = new Node(key); - Every node has a different address, so this was incorrect
