...
public class minimumDepth {
    ...
    public minimumDepth(int key){
        root = new Node(key);
    }

    public int findingMinDepth(Node key){
        if(root == null)
            return -1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("So the minimum depth of this Binary Tree is: " + BT.findingMinDepth(BT.root));
    }
}
